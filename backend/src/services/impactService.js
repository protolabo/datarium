// Service chargé de convertir des octets (bytes) en impact énergétique (kWh)
// et environnemental (g CO₂), puis de déterminer le niveau de couleur du thermomètre.

import { KWH_FACTOR, CO2_FACTOR, THERMO_UNIT, THRESHOLDS_KWH, THRESHOLDS_CO2 } from '../config/env.js';
