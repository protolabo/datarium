...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  late Timer timer;
  final DataService _dataService = DataService(); // ✅ Étape 3
  ...
  void initState() {
    ...
    _fetchAndUpdateData(); // ✅ Étape 4

    timer = Timer.periodic(const Duration(seconds: 2), (_) {
      _fetchAndUpdateData(); // ✅ Remplace _generateRandomData
    });
