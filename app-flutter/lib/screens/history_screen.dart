...
class _HistoryScreenState extends State<HistoryScreen> {
  List<Map<String, String>> dummyHistory = [
    {"time": "2025-07-16 17:22", "app": "Mining", "kwh": "2.3"},
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const Text(
              "Consommation énergétique par jour (kWh)",
